 ...
 * forms internally. If you store one, it creates the other.  The standard
 * Sun Date won't handle dates prior to 1970 among other problems. BigDate
 * handles dates 999,999 BC Jan 1 to 999,999 AD Dec 31, 0 = 1970 Jan 1.  Are
 ...
 * 999,999BC.</dd> <dt>no</dt> <dd>leap seconds.</dd></dl>  Normally all you
 ...
 * 2001 to represent the year 2001 and 12 to represent December.  BigDate
 ...
 * avoid confusion, this calendar always uses January 1.  TODO Future
...
public class BigDate implements Cloneable, Serializable, Comparable<Object> {
	 ...
	 * converted into the equivalent valid one. e.g. 1954 September 31 -&gt;
	 * 1954 October 1.  1954 October -1 -&gt; 1954 September 29. 1954 13
	 * 01 -&gt; 1955 01 01.
	 */
	...
	/**
	 * Clean up an invalid date, leaving the results internally. e.g. 1954
	 * September 31 -&gt; 1954 October 1.  1954 October -1 -&gt; 1954 September
	 * 29. 1954 13 01 -&gt; 1955 01 01. This lets you do year, month or day
