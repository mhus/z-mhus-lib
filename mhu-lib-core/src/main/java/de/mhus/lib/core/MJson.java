...
public class MJson {
	 ...
	 * @throws IOException
	 */
	public static Object jsonToPojo(JsonNode from, Object to) throws IOException {
		return jsonToPojo(from, to, null);
	}
	
	public static Object jsonToPojo(JsonNode from, Object to, TransformHelper helper) throws IOException {
		if (helper == null) helper = new TransformHelper();
		if (to == null) {
	...
	public static class TransformHelper {
		...
		private boolean rememberClass = true;
		...
		public Object createObject(JsonNode from) {
